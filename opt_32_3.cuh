// Change block size from 128 threads per block to 256 threads per block
template <int kernel, int block_y>
__launch_bounds__(32 * block_y, 1)
__global__ void opt3wl79_32x32x32(float *in) {
...
template <int mode>
void opt3wl79_32x32x32_h(float *in, const int bx, const int by, const int bz) {
        const int block_y = 8;
        dim3 threads(32, block_y, 1);
        dim3 blocks(bx, by, bz);
        opt3wl79_32x32x32<mode, block_y><<<blocks, threads>>>(in);
